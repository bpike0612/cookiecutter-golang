...
[![Build Status](https://travis-ci.org/bpike0612/cookiecutter-golang.svg?branch=master)](https://travis-ci.org/bpike0612/cookiecutter-golang)
...
You can find the image dokcer file in this [repo](https://github.com/bpike0612/alpine-golang-buildimage) and more information about docker multistage builds in this [blog post](https://www.critiqus.com/post/multi-stage-docker-builds/).
...
```console
$ cookiecutter https://github.com/bpike0612/cookiecutter-golang.git
```

You will be asked about your basic info (name, project name, app name, etc.). This info will be used to customize your new project.

Warning: After this point, change 'Brett Pike', 'bpike0612', etc to your own information.

Answer the prompts with your own desired [options](). For example:
```console
full_name [Brett Pike]: Brett Pike
github_username [bpike0612]: bpike0612
app_name [mygolangproject]: echoserver
project_short_description [A Golang project.]: Awesome Echo Server
docker_hub_username [bpike0612]: bpike0612
docker_image [bpike0612/docker-alpine:latest]: bpike0612/docker-alpine:latest
docker_build_image [bpike0612/docker-alpine:gobuildimage]: bpike0612/docker-alpine:gobuildimage
use_docker [y]: y
use_git [y]: y
...
- [iothub](https://github.com/bpike0612/iothub) websocket multiroom server for IoT
