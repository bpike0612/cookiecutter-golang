...
def context():
    return {
        ...
        'github_username': 'bpike0612',
        'app_name': 'MyTestProject',
        'project_short_description': 'A short description of the project.',
        "docker_hub_username": "bpike0612",
        "docker_image": "bpike0612/docker-alpine:latest",
        "docker_build_image": "bpike0612/docker-alpine:gobuildimage",
        "use_docker": "y",
        "use_git": "y",
